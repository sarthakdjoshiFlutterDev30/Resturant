        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div id="contact-form" data-aos="fade-right">
              <h2 className="text-3xl md:text-4xl font-playfair font-bold text-dark-900 mb-6">
                Get in <span className="gradient-text">Touch</span>
              </h2>
              <p className="text-dark-600 mb-8 leading-relaxed">
                Whether you're planning a special celebration, have questions about our menu, 
                or want to make a reservation, we're here to help make your experience exceptional.
              </p>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 transition-colors duration-300 ${
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                      <label htmlFor="date" className="block text-sm font-semibold text-dark-900 mb-2">
                        Preferred Date
                      </label>
                      <input
                        type="date"
                        ...
                        value={formData.date}
                        onChange={handleChange}
                        className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 transition-colors duration-300"
                      />
                    </div>

                    <div>
                      <label htmlFor="time" className="block text-sm font-semibold text-dark-900 mb-2">
                        Preferred Time
                      </label>
                      <select
                        id="time"
                    ...
                    <div>
                      <label htmlFor="guests" className="block text-sm font-semibold text-dark-900 mb-2">
                        Number of Guests
                      </label>
                      <select
                        id="guests"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="5"
                      className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 transition-colors duration-300 resize-vertical ${
                        errors.message ? 'border-red-500' : 'border-gray-300'
                      }`}
                      placeholder="Tell us about your special occasion, dietary requirements, or any other details..."
                    ></textarea>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-dark-600">info@gourmettable.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-dark-900 mb-1">Opening Hours</h3>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-playfair font-bold mb-6">
              Ready to Dine <span className="text-accent-400">With Us?</span>
            </h2>
            <p className="text-xl mb-10 max-w-2xl mx-auto text-white/80 leading-relaxed">
              Book your table now and prepare for an unforgettable culinary experience
            </p>
            <button 
